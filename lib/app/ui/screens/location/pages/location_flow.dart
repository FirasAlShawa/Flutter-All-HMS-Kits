...
class LocationFlowPage extends StatelessWidget {
  static const String routeName = "LocationFlowPage";
  LocationFlowPage();
  @override
  Widget build(BuildContext context) {
    return LocationFlowPageStateful(title: "HMS Location Kit",);
  }
}

class LocationFlowPageStateful extends StatefulWidget {
  LocationFlowPageStateful({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _LocationFlowPageState createState() => _LocationFlowPageState();
}

class _LocationFlowPageState extends State<LocationFlowPageStateful> {
