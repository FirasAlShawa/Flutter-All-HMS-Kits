                        ...
                        Expanded(
                          ...
                          child: Padding(
                              ...
                              child: RaisedButton(
                                ...
                                child:
                                Text('Turn On Push', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 1,
                          child: Padding(
                              ...
                              child: RaisedButton(
                                ...
                                child:
                                Text('Turn Off Push', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 1,
                      ...
                      Row(children: <Widget>[
                        Expanded(
                          ...
                          child: Padding(
                              ...
                              child: RaisedButton(
                                onPressed: () => getId(),
                                child: Text('GetID', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 1,
                          child: Padding(
                              ...
                              child: RaisedButton(
                                onPressed: () => getAAID(),
                                child: Text('GetAAID', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 1,
                          child: Padding(
                              ...
                              child: RaisedButton(
                                ...
                                child:
                                Text('DeleteAAID', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                      ]),
                      Row(children: <Widget>[
                        Expanded(
                          ...
                          child: Padding(
                              ...
                              child: RaisedButton(
                                onPressed: () => getToken(),
                                child: Text('GetToken', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 5,
                          child: Padding(
                              ...
                              child: RaisedButton(
                                ...
                                child:
                                Text('DeleteToken', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 5,
                          child: Padding(
                              ...
                              child: RaisedButton(
                                onPressed: () => clearLog(),
                                child: Text('ClearLog', style: TextStyle(fontSize: 12, color: Colors.white)),
                                color: Colors.red,
                              )),
                        ),
                      ]),
                      ...
                      Row(children: <Widget>[
                        Expanded(
                          ...
                          child: Padding(
                              ...
                              child: RaisedButton(
                                onPressed: () => subscribe(),
                                child: Text('Subsribe', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 5,
                          child: Padding(
                              ...
                              child: RaisedButton(
                                ...
                                child:
                                Text('UnSubscribe', style: TextStyle(fontSize: 12)),
                              )),
                        ),
                        Expanded(
                          flex: 5,
