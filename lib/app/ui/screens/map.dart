...
class HmsMaps extends StatelessWidget {
  HmsMaps();
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: FloatingActionButton(
                          ...
                          child: const Icon(Icons.settings_remote, size: 36.0),
                        ),
                      ),
  ...
  Future<void> _createMarkerImageFromAsset(BuildContext context) async {
    if (_markerIcon == null) {
      ...
      BitmapDescriptor.fromAssetImage(
              imageConfiguration, 'assets/images/huawei-logo.png')
          .then(_updateBitmap);
    }
  }
